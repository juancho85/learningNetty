...
public class TimeDecoder extends ByteToMessageDecoder { // (1)
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) { // (2)
        ...
        // If decode() adds an object to out, it means the decoder decoded a message successfully. ByteToMessageDecoder
        // will discard the read part of the cumulative buffer. Please remember that you don't need to decode multiple
        // messages. ByteToMessageDecoder will keep calling the decode() method until it adds nothing to out.
